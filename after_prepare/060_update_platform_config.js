...
/** This hook updates platform configuration files based on preferences and config-file data defined in config.xml.
 ...
 <preference name="android-application-name" value="ch.insentia.mobile.lab.IsaApplication" />
...
var platformConfig = (function(){
    ...
    var preferenceMappingData = {
        'android': {
            ...
            'android-application-name': {target: 'AndroidManifest.xml', parent: 'application', destination: 'android:name'}
        },
        'ios': {}
    };
